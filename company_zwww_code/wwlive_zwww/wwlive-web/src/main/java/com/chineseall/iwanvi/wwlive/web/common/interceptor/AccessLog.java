	...
	public void writeToFile() {
		...
		try {
			...
			stringBuilder.append(system).append(SPILT)
					...
					.append(pin).append(SPILT).append(referer).append(SPILT)
					.append(uri).append(SPILT).append(url).append(SPILT)
					.append(methodType).append(SPILT).append(ip).append(SPILT)
					.append(ua).append(SPILT).append(wwa);
			...
			if (extendMap != null) {
				ObjectMapper objectMapper = new ObjectMapper();
				stringBuilder
						.append(objectMapper.writeValueAsString(extendMap));
			}
